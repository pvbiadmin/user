...
import Product1 from "../../assets/images/product/product-cart-1.png";
                ...
                <Card.Body>
                  <Row>
                    ...
                    <Col md={6} lg={6} sm={6} xs={6}>
                      ...
                      <h6><span className="fw-bold">Quantity:</span> 5</h6>
                      <h6><span className="fw-bold">Price:</span> USD 5,000.00 (5 * 100)</h6>
                    </Col>
